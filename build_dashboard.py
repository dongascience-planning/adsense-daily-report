...
# 📅 9월 실행 계획 (WBS · 할 일 + 확인할 데이터). do=할 일, chk=확인할 데이터
# 8월 패턴: 수익~트래픽 상관 0.94 · 효율(RPM) 안정 → 9월은 광고가 아니라 '트래픽'이 레버
PLAN = [
    {"week": "🎯 9월 핵심 · 트래픽 = 유일한 큰 레버 (8월 근거: 수익~트래픽 상관 0.94)", "days": [
        {"date": "근거", "label": "효율은 천장(RPM $0.91 안정) — 돈은 트래픽이 좌우",
         "do": ["광고 위치 추가 튜닝은 중단 — 효과 미미. 자원을 트래픽으로 집중",
                "충족률은 이미 80%대 안정 → 새 최적화 대신 '방어'만"],
         "chk": ["트래픽 늘면 수익이 그대로 따라오나 (8월엔 0.94로 직결)"]},
    ]},
    {"week": "📉 주중 저점 메우기 · 특히 화요일", "days": [
        {"date": "화·목", "label": "저조 요일만 끌어올려도 월합이 오른다",
         "do": ["8월 화요일 31k pv(일·월 44k의 70%) — 화·목에 강한 기사·발행 배치",
                "요일 저점 트래픽을 주말 수준으로 끌어올리기"],
         "chk": ["화·목 페이지뷰가 주말 수준에 근접하나"]},
    ]},
    {"week": "📈 히트 기사 재현 (상위 수익일 = 전부 고트래픽일)", "days": [
        {"date": "상시", "label": "터진 기사 패턴을 기획적으로 반복",
         "do": ["8월 상위 수익일(8/3·8/22~26)은 모두 고트래픽 → 기사 주제·유형 분석",
                "편집팀과 협업해 유사 기획 반복 · ⚠️ 질 좋은 유입만(무효 트래픽 경계)"],
         "chk": ["고트래픽 히트가 월 몇 회 나오나 · 충족률 안 깨지나"]},
    ]},
]
...
<body>
  ...
  <details class="archive">
    ...
    <div class="links">
      <a href="광고수익_8월_원페이지.html" target="_blank">8월 성과 원페이지</a> ·
